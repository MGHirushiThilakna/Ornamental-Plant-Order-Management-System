...
<head>
    ...
    <title>Staff Login -Sunshine Plant House</title>
    <!-- Bootstrap-->
    ...
    <nav class="navbar navbar-expand-lg myNavbar" >
        <div class="container-fluid" style="border-style: solid;">
            <div class="myNavbar header">
                    ...
                    <div class="notification_icon_container">Sign In</div>
                        
                        <a class="channel_symbol_btn" href="staffLogin.php">
                        <img class="channel_symbol" src="assets/imgs/signin.png">
