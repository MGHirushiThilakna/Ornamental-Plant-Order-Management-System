...
if(isset($_REQUEST['validateEmail'])){
    $res = $cuObj -> checkEmailInDB($_REQUEST['validateEmail']);
    if($res){
        echo 1;
    }else{
        echo 0;
