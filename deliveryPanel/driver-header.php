...
<head>
    ...
    <title>Driver - Sunshine Plant House</title>
    ...
    <nav class="navbar navbar-expand-lg myNavbar" >
        <div class="container-fluid" style="border-style: solid;">
            <div class="myNavbar header">
                    ...
                    <a <?php echo $currentMainPage == 'profile' ? 'active' : '' ?>  href="driverProfile.php">Settings</a>
...
<script>                 // drop down menu f
    ...
    window.onclick = function(event) {
        ...
        <div class=" main_sidebar">
			<a href="../staffPanel/index.php" style="height:56px" ><span class=" admin_panel_lbl" style="font-size:19px">Driver Panel</span></a>
                <div class="side_bar">
                ...
                <a class="nav_side_bar" <?php echo $currentMainPage == 'delivery' ? 'active' : '' ?>  href="viewReadyOrders.php">
                        
                        <div class="sidebar_link">
                            <div class="sidebar_icon_div">
                            <img  src="../assets/imgs/my_icons/hamburger-menu.svg">
                            </div>
                                <div class="sidebar_cell_text">Delivery Handling</div> 
                        </div>
                    </a>
