        ...
        <div class="col-md-6 mb-1 my-col">
            <div class="card">
                <form id="SaveStaffInfo">
                    <?php  
                        $result = $driveObj -> getInfoForUpdate($driverID);
                        if($result){
                           $Drivere = $result -> fetch_assoc(); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-floating myFormFloating">
                                <input type="text" class="form-control myinputText yourForm" name="FName" id="floatingInput" placeholder=" " value="<?=$Drivere['FName']?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-floating myFormFloating">
                                <input type="text" class="form-control myinputText yourForm" name="LName" id="floatingInput" placeholder=" " value="<?=$Drivere['LName']?>">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-floating myFormFloating">
                                <input type="text" class="form-control myinputText yourForm" name="email" id="floatingInput" placeholder=" " value="<?=$Drivere['Email']?>">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-floating myFormFloating">
                                <input type="text" class="form-control myinputText yourForm" name="contact" id="floatingInput" placeholder=" " value="<?=$Drivere['Contact_No']?>">
...
<script src="..\assets\js\driver-profile.js"></script>

<?php include "driver-footer.php";?>