...
<div class="dashboard-summary">
    ...
    <div class="summary-card confirmed-orders">
      <div class="card-content">
        ...
        <div class="info">
          ...
          <p class="count" id="OTW-count">0</p>
        </div>
      </div>
    </div>
  </a>
  ...
  <div class="summary-card dispatched-orders">
    <div class="card-content">
      ...
      <div class="info">
        <h3>Collected COD Cash</h3>
        <p class="count" id="cod-count">Rs.0.00</p>
      </div>
    </div>
  </div>
  </a>
...
function updateDashboardCounts(summary) {
    ...
    $('#cod-count').text('Rs.' + (summary.totalAmount || 0).toFixed(2));
