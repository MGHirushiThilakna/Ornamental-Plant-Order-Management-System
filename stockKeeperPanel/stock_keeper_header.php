...
<head>
    ...
    <title>Stock Keeper-Sunshine Plant House</title>
    ...
    <nav class="navbar navbar-expand-lg myNavbar" >
        <div class="container-fluid" style="border-style: solid;">
            <div class="myNavbar header">
                    ...
                    <a <?php echo $currentMainPage == 'profile' ? 'active' : '' ?>  href="stock_keeper_profile.php">Settings</a>
...
<script>                 // drop down menu f
    ...
    window.onclick = function(event) {
        ...
        <div class=" main_sidebar">
			<a href="../staffPanel/index.php" style="height:56px" ><span class=" admin_panel_lbl" style="font-size:19px" >Stock Keeper Panel</span></a>
                <div class="side_bar">
                ...
                <a class="nav_side_bar" <?php echo $currentMainPage == 'KeeperNewOrders' ? 'active' : '' ?>  href="view_stock_KeeperNewOrders.php">
